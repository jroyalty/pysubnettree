...
SWIGINTERN PyObject *_wrap_SubnetTree_todict(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  SubnetTree *arg1 = (SubnetTree *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:SubnetTree_todict",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_SubnetTree, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "SubnetTree_todict" "', argument " "1"" of type '" "SubnetTree const *""'"); 
  }
  arg1 = reinterpret_cast< SubnetTree * >(argp1);
  result = (PyObject *)((SubnetTree const *)arg1)->todict();
  resultobj = result;
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"SubnetTree_todict", _wrap_SubnetTree_todict, METH_VARARGS, NULL},
